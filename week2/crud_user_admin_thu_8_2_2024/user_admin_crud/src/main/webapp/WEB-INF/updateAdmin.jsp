                    ...
                    <form action="/updateAdmin/${admin.id}" method="post">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="userName" id="username"
                                placeholder="User Name" value="${admin.username}">
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="email" class="form-control" name="email" id="email"
                                aria-describedby="emailHelp" placeholder="Enter email" value="${admin.email}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="phone">Phone Number</label>
                            <input type="tel" class="form-control" id="phone" name="phoneNumber"
                                value="${admin.phoneNumber}" placeholder="User Name" />
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <button type="submit" class="btn btn-primary mb-5">Update Admin</button>
                    </form>
