                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <%@ include file="../componets/toolbar.jsp" %>
                                    <div class="d-flex mb-5">
                                        ...
                                        <a type="button" href="addArea" class="btn me-1 btn-success">Add +</a>
                                    </div>
                                ...
                                <table class="table  table-borderless" style="width:100%" id="table">
                                    <thead class="p-1">
                                        <tr>
                                            ...
                                            <th scope="col" style="width:60%">Area Description</th>
                                        ...
                                        <c:forEach items="${areas}" var="area">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="deleteArea/${area.id}" class="btn btn-danger">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
