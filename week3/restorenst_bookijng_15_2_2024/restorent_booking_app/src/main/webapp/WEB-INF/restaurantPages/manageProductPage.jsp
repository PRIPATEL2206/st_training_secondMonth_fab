                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <%@ include file="../componets/toolbar.jsp" %>
                                    <div class="d-flex mb-5">
                                        ...
                                        <a type="button" href="addProduct" class="btn me-1 btn-success">Add +</a>
                                    </div>
                            </div>
                                    ...
                                    <tbody>
                                        <c:forEach items="${products}" var="product">
                                            <tr>
                                                ...
                                                <td>${categories.get(product.categoryId)}</td>
                                                <td>${subCategories.get(product.subCategoryId)}</td>
                                                <td> ${product.productName}</td>
                                                <td>
                                                    <a href="/products/${product.produtImage}" class="btn btn-primary ">
